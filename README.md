# Minghao Dang — Academic Website

Bilingual academic website. English: index.html; Chinese: zh.html.
...
Server-only analytics is excluded from this version.
Custom domain is not configured yet. Do not add a CNAME until ownership and DNS are configured.
